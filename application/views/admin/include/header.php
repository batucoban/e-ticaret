...
<head>
    ...
    <title>eTicaret Admin | <?php if(isset($head)){echo $head;} ?></title>
...
<div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
        <img class="animation__shake" src="<?php echo base_url('assets/back/');?>dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
    </div>
