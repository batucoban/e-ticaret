...
<div class="offcanvas-menu-wrapper">
    ...
    <div class="offcanvas__nav__option">
        <a href="#" class="search-switch"><img src="<?= base_url('assets/front/') ?>img/icon/search.png" alt=""></a>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-3">
                <div class="header__logo">
                    <a href="./index.html"><img src="<?= base_url('assets/front/') ?>img/logo.png" alt=""></a>
                </div>
            </div>
